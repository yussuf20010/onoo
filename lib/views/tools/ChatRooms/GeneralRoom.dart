...
class GeneralRoom extends StatefulWidget {
  const GeneralRoom({Key? key}) : super(key: key);
...
class _GeneralRoomState extends State<GeneralRoom>
    with AutomaticKeepAliveClientMixin<GeneralRoom> {
        ...
        builder:
          ...
          if (snapshot.hasData && snapshot.data != ConnectivityResult.none) {
            return InAppWebView(
              key: webViewKey,
              initialUrlRequest:
              URLRequest(url: WebUri('https://tlk.io/medithenai-general')),
              initialSettings:
