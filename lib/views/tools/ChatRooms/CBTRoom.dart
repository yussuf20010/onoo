...
class CBTRoom extends StatefulWidget {
  const CBTRoom({Key? key}) : super(key: key);

  @override
  State<CBTRoom> createState() => _CBTRoomState();
}

class _CBTRoomState extends State<CBTRoom>
    with AutomaticKeepAliveClientMixin<CBTRoom> {
        ...
        builder:
          ...
          if (snapshot.hasData && snapshot.data != ConnectivityResult.none) {
            return InAppWebView(
              key: webViewKey,
              initialUrlRequest:
              URLRequest(url: WebUri('https://tlk.io/medithenai-cbt')),
              initialSettings:
