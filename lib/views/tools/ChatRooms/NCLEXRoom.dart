...
class NclexRoom extends StatefulWidget {
  const NclexRoom({Key? key}) : super(key: key);

  @override
  State<NclexRoom> createState() => _NclexRoomState();
}

class _NclexRoomState extends State<NclexRoom>
    with AutomaticKeepAliveClientMixin<NclexRoom> {
        ...
        builder:
          ...
          if (snapshot.hasData && snapshot.data != ConnectivityResult.none) {
            return InAppWebView(
              key: webViewKey,
              initialUrlRequest:
              URLRequest(url: WebUri('https://tlk.io/medithenai-nclex')),
              initialSettings:
