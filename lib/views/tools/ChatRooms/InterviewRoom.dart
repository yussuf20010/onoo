...
class InterviewRoom extends StatefulWidget {
  const InterviewRoom({Key? key}) : super(key: key);
...
class _InterviewRoomState extends State<InterviewRoom>
    with AutomaticKeepAliveClientMixin<InterviewRoom> {
        ...
        builder:
          ...
          if (snapshot.hasData && snapshot.data != ConnectivityResult.none) {
            return InAppWebView(
              key: webViewKey,
              initialUrlRequest:
              URLRequest(url: WebUri('https://tlk.io/medithenai-egyptianinterview')),
              initialSettings:
              ...
              onLoadStop: (controller, url) async {
                _changeTitleText('Interview Room');
