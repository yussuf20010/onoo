...
class ORRoom extends StatefulWidget {
  const ORRoom({Key? key}) : super(key: key);

  @override
  State<ORRoom> createState() => _ORRoomState();
}

class _ORRoomState extends State<ORRoom>
    with AutomaticKeepAliveClientMixin<ORRoom> {
        ...
        builder:
          ...
          if (snapshot.hasData && snapshot.data != ConnectivityResult.none) {
            return InAppWebView(
              key: webViewKey,
              initialUrlRequest:
              URLRequest(url: WebUri('https://tlk.io/medithenai-or')),
              initialSettings:
