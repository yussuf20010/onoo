...
class ProMetricRoom extends StatefulWidget {
  const ProMetricRoom({Key? key}) : super(key: key);

  @override
  State<ProMetricRoom> createState() => _ProMetricRoomState();
}

class _ProMetricRoomState extends State<ProMetricRoom>
    with AutomaticKeepAliveClientMixin<ProMetricRoom> {
        ...
        builder:
          ...
          if (snapshot.hasData && snapshot.data != ConnectivityResult.none) {
            return InAppWebView(
              key: webViewKey,
              initialUrlRequest:
              URLRequest(url: WebUri('https://tlk.io/medithenai-prometric')),
              initialSettings:
              ...
              onLoadStop: (controller, url) async {
                _changeTitleText('ProMetric Room');
