...
class ICURoom extends StatefulWidget {
  const ICURoom({Key? key}) : super(key: key);

  @override
  State<ICURoom> createState() => _ICURoomState();
}

class _ICURoomState extends State<ICURoom>
    with AutomaticKeepAliveClientMixin<ICURoom> {
        ...
        builder:
          ...
          if (snapshot.hasData && snapshot.data != ConnectivityResult.none) {
            return InAppWebView(
              key: webViewKey,
              initialUrlRequest:
              URLRequest(url: WebUri('https://tlk.io/medithenai-icu')),
              initialSettings:
