...
class WardRoom extends StatefulWidget {
  const WardRoom({Key? key}) : super(key: key);

  @override
  State<WardRoom> createState() => _WardRoomState();
}

class _WardRoomState extends State<WardRoom>
    with AutomaticKeepAliveClientMixin<WardRoom> {
        ...
        builder:
          ...
          if (snapshot.hasData && snapshot.data != ConnectivityResult.none) {
            return InAppWebView(
              key: webViewKey,
              initialUrlRequest:
              URLRequest(url: WebUri('https://tlk.io/medithenai-ward')),
              initialSettings:
