...
class PediatricDosageCalculatorApp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Dosage Calculator',
      home: DosageCalculator(),
    );
  }
}
...
class DosageCalculator extends StatefulWidget {
  @override
  _DosageCalculatorState createState() => _DosageCalculatorState();
}
...
class _DosageCalculatorState extends State<DosageCalculator> {
  ...
  void calculateDoses() {
    setState(() {
      totalDailyDose = doseInMgKg * patientWeightKg * frequencyMultiplier(selectedFrequency);
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Pediatric Dosage Calculator'),
      ),
      body: Padding(
