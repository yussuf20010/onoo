...
import 'CBT_PartSix_Questions.dart'; // Changed to Part Six
...
class CBTPartSixNursingQuestions extends StatelessWidget { // Changed class name
  const CBTPartSixNursingQuestions({Key? key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'CBT Questions Part Six', // Changed title
        theme: theme,
        darkTheme: darkTheme,
        home: CBTPartSixSubNursingQuestions(), // Changed to Part Six
      ),
    );
  }
}

class CBTPartSixSubNursingQuestions extends StatefulWidget { // Changed class name
  const CBTPartSixSubNursingQuestions({Key? key});

  @override
  _CBTPartSixSubNursingQuestionsState createState() =>
      _CBTPartSixSubNursingQuestionsState();
}

class _CBTPartSixSubNursingQuestionsState
    extends State<CBTPartSixSubNursingQuestions> {
  List<Map<String, dynamic>> questions = CBTPartSixQuestions; // Use Part Six questions
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Part (6) - Question ${currentQuestionIndex + 1}'), // Changed to Part Six
        leading: IconButton(
