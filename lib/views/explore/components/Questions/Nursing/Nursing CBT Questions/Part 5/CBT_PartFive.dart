...
import 'CBT_PartFive_Questions.dart'; // Changed to Part Five
...
class CBTPartFiveNursingQuestions extends StatelessWidget { // Changed class name
  const CBTPartFiveNursingQuestions({Key? key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'CBT Questions Part Five', // Changed title
        theme: theme,
        darkTheme: darkTheme,
        home: CBTPartFiveSubNursingQuestions(), // Changed to Part Five
      ),
    );
  }
}

class CBTPartFiveSubNursingQuestions extends StatefulWidget { // Changed class name
  const CBTPartFiveSubNursingQuestions({Key? key});

  @override
  _CBTPartFiveSubNursingQuestionsState createState() =>
      _CBTPartFiveSubNursingQuestionsState();
}

class _CBTPartFiveSubNursingQuestionsState
    extends State<CBTPartFiveSubNursingQuestions> {
  List<Map<String, dynamic>> questions = CBTPartFiveQuestions; // Use Part Five questions
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Part (5) - Question ${currentQuestionIndex + 1}'), // Changed to Part Five
        leading: IconButton(
