...
import 'CBT_PartFour_Questions.dart';
...
class CBTPartFourNursingQuestions extends StatelessWidget {
  const CBTPartFourNursingQuestions({Key? key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'CBT Questions Part Four',
        theme: theme,
        darkTheme: darkTheme,
        home: CBTPartFourSubNursingQuestions(),
      ),
    );
  }
}

class CBTPartFourSubNursingQuestions extends StatefulWidget {
  const CBTPartFourSubNursingQuestions({Key? key});

  @override
  _CBTPartFourSubNursingQuestionsState createState() =>
      _CBTPartFourSubNursingQuestionsState();
}

class _CBTPartFourSubNursingQuestionsState
    extends State<CBTPartFourSubNursingQuestions> {
  List<Map<String, dynamic>> questions = CBTPartFourQuestions; // Use Part Four questions
