...
import 'CBT_PartThree_Questions.dart';
...
class CBTPartThreeNursingQuestions extends StatelessWidget {
  const CBTPartThreeNursingQuestions({Key? key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'CBT Questions Part Three',
        theme: theme,
        darkTheme: darkTheme,
        home: CBTPartThreeSubNursingQuestions(),
      ),
    );
  }
}

class CBTPartThreeSubNursingQuestions extends StatefulWidget {
  const CBTPartThreeSubNursingQuestions({Key? key});

  @override
  _CBTPartThreeSubNursingQuestionsState createState() =>
      _CBTPartThreeSubNursingQuestionsState();
}

class _CBTPartThreeSubNursingQuestionsState
    extends State<CBTPartThreeSubNursingQuestions> {
  List<Map<String, dynamic>> questions = CBTPartThreeQuestions; // Use Part Three questions
