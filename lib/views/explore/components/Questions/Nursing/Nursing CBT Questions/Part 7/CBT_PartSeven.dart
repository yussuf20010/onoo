...
import 'CBT_PartSeven_Questions.dart'; // Changed to Part Seven
...
class CBTPartSevenNursingQuestions extends StatelessWidget { // Changed class name
  const CBTPartSevenNursingQuestions({Key? key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'CBT Questions Part Seven', // Changed title
        theme: theme,
        darkTheme: darkTheme,
        home: CBTPartSevenSubNursingQuestions(), // Changed to Part Seven
      ),
    );
  }
}

class CBTPartSevenSubNursingQuestions extends StatefulWidget { // Changed class name
  const CBTPartSevenSubNursingQuestions({Key? key});

  @override
  _CBTPartSevenSubNursingQuestionsState createState() =>
      _CBTPartSevenSubNursingQuestionsState();
}

class _CBTPartSevenSubNursingQuestionsState
    extends State<CBTPartSevenSubNursingQuestions> {
  List<Map<String, dynamic>> questions = CBTPartSevenQuestions; // Use Part Seven questions
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Part (7) - Question ${currentQuestionIndex + 1}'), // Changed to Part Seven
        leading: IconButton(
