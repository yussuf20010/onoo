...
import 'CBT_PartTwo_Questions.dart';
...
class CBTPartTwoNursingQuestions extends StatelessWidget {
  const CBTPartTwoNursingQuestions({Key? key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'CBT Questions Part Two',
        theme: theme,
        darkTheme: darkTheme,
        home: CBTPartTwoSubNursingQuestions(),
      ),
    );
  }
}

class CBTPartTwoSubNursingQuestions extends StatefulWidget {
  const CBTPartTwoSubNursingQuestions({Key? key});

  @override
  _CBTPartTwoSubNursingQuestionsState createState() =>
      _CBTPartTwoSubNursingQuestionsState();
}

class _CBTPartTwoSubNursingQuestionsState
    extends State<CBTPartTwoSubNursingQuestions> {
  List<Map<String, dynamic>> questions = CBTPartTwoQuestions; // Use Part Two questions
