...
import 'OR_PartFive_Questions.dart';
...
class ORPartFiveNursingInterview extends StatelessWidget {
  const ORPartFiveNursingInterview({super.key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'OR Part Five Nursing Interview Questions',
        theme: theme,
        darkTheme: darkTheme,
        home: ORPartFive_SubNursingInterview(),
      ),
    );
  }
}

class ORPartFive_SubNursingInterview extends StatefulWidget {
  const ORPartFive_SubNursingInterview({super.key});

  @override
  _ORPartFive_SubNursingInterviewState createState() =>
      _ORPartFive_SubNursingInterviewState();
}

class _ORPartFive_SubNursingInterviewState
    extends State<ORPartFive_SubNursingInterview> {
  List<Map<String, dynamic>> questions = oRPartFiveQuestions; // Use OR_PartFive_Questions.dart
