...
import 'OR_PartThree_Questions.dart';
...
class ORPartThreeNursingInterview extends StatelessWidget {
  const ORPartThreeNursingInterview({super.key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'OR Part Three Nursing Interview Questions',
        theme: theme,
        darkTheme: darkTheme,
        home: ORPartThree_SubNursingInterview(),
      ),
    );
  }
}

class ORPartThree_SubNursingInterview extends StatefulWidget {
  const ORPartThree_SubNursingInterview({super.key});

  @override
  _ORPartThree_SubNursingInterviewState createState() =>
      _ORPartThree_SubNursingInterviewState();
}

class _ORPartThree_SubNursingInterviewState
    extends State<ORPartThree_SubNursingInterview> {
  List<Map<String, dynamic>> questions = oRPartThreeQuestions;
