...
import 'ECG_PartFour_Questions.dart'; // Updated import for part four questions
...
class ECGPartFourNursingInterview extends StatelessWidget {
  const ECGPartFourNursingInterview({super.key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'ECG Part Four Nursing Interview Questions',
        theme: theme,
        darkTheme: darkTheme,
        home: ECGPartFour_SubNursingInterview(),
      ),
    );
  }
}

class ECGPartFour_SubNursingInterview extends StatefulWidget {
  const ECGPartFour_SubNursingInterview({super.key});

  @override
  _ECGPartFour_SubNursingInterviewState createState() =>
      _ECGPartFour_SubNursingInterviewState();
}

class _ECGPartFour_SubNursingInterviewState
    extends State<ECGPartFour_SubNursingInterview> {
  List<Map<String, dynamic>> questions = ECGPartFourQuestions;
