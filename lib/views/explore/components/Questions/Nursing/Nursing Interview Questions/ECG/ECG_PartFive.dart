...
import 'ECG_PartFive_Questions.dart'; // Updated import for part five questions
...
class ECGPartFiveNursingInterview extends StatelessWidget {
  const ECGPartFiveNursingInterview({super.key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'ECG Part Five Nursing Interview Questions',
        theme: theme,
        darkTheme: darkTheme,
        home: ECGPartFive_SubNursingInterview(),
      ),
    );
  }
}

class ECGPartFive_SubNursingInterview extends StatefulWidget {
  const ECGPartFive_SubNursingInterview({super.key});

  @override
  _ECGPartFive_SubNursingInterviewState createState() =>
      _ECGPartFive_SubNursingInterviewState();
}

class _ECGPartFive_SubNursingInterviewState
    extends State<ECGPartFive_SubNursingInterview> {
  List<Map<String, dynamic>> questions = ECGPartFiveQuestions;
