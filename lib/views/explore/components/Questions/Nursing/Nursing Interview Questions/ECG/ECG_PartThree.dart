...
import 'ECG_PartThree_Questions.dart';
...
class ECGPartThreeNursingInterview extends StatelessWidget {
  const ECGPartThreeNursingInterview({super.key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'ECG Part Three Nursing Interview Questions',
        theme: theme,
        darkTheme: darkTheme,
        home: ECGPartThree_SubNursingInterview(),
      ),
    );
  }
}

class ECGPartThree_SubNursingInterview extends StatefulWidget {
  const ECGPartThree_SubNursingInterview({super.key});

  @override
  _ECGPartThree_SubNursingInterviewState createState() =>
      _ECGPartThree_SubNursingInterviewState();
}

class _ECGPartThree_SubNursingInterviewState
    extends State<ECGPartThree_SubNursingInterview> {
  List<Map<String, dynamic>> questions = ECGPartThreeQuestions;
