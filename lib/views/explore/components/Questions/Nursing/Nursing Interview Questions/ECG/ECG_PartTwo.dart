...
import 'ECG_PartTwo_Questions.dart'; // Updated import for part two questions
...
class ECGPartTwoNursingInterview extends StatelessWidget {
  const ECGPartTwoNursingInterview({super.key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'ECG Part Two Nursing Interview Questions',
        theme: theme,
        darkTheme: darkTheme,
        home: ECGPartTwo_SubNursingInterview(),
      ),
    );
  }
}

class ECGPartTwo_SubNursingInterview extends StatefulWidget {
  const ECGPartTwo_SubNursingInterview({super.key});

  @override
  _ECGPartTwo_SubNursingInterviewState createState() =>
      _ECGPartTwo_SubNursingInterviewState();
}

class _ECGPartTwo_SubNursingInterviewState
    extends State<ECGPartTwo_SubNursingInterview> {
  List<Map<String, dynamic>> questions = ECGPartTwoQuestions;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Part (2) - Question ${currentQuestionIndex + 1}'), // Updated part number
        leading: IconButton(
