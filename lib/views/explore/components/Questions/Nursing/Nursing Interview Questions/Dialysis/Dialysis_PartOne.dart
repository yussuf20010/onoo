...
import 'Dialysis_PartOne_Questions.dart';
...
class DialysisPartOneNursingInterview extends StatelessWidget {
  const DialysisPartOneNursingInterview({Key? key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'Dialysis Interview Questions Part (1)',
        theme: theme,
        darkTheme: darkTheme,
        home: DialysisPartOne_SubNursingInterview(),
      ),
    );
  }
}

class DialysisPartOne_SubNursingInterview extends StatefulWidget {
  const DialysisPartOne_SubNursingInterview({super.key});

  @override
  _DialysisPartOne_SubNursingInterviewState createState() =>
      _DialysisPartOne_SubNursingInterviewState();
}

class _DialysisPartOne_SubNursingInterviewState extends State<DialysisPartOne_SubNursingInterview> {
  List<Map<String, dynamic>> questions = dialysisPartOneQuestions;
