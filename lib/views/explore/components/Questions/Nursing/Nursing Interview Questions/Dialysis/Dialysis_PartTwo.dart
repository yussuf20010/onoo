...
import 'Dialysis_PartTwo_Questions.dart';
...
class DialysisPartTwoNursingInterview extends StatelessWidget {
  const DialysisPartTwoNursingInterview({super.key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'Dialysis Interview Questions Part (2)',
        theme: theme,
        darkTheme: darkTheme,
        home: DialysisPartTwo_SubNursingInterview(),
      ),
    );
  }
}

class DialysisPartTwo_SubNursingInterview extends StatefulWidget {
  const DialysisPartTwo_SubNursingInterview({super.key});

  @override
  _DialysisPartTwo_SubNursingInterviewState createState() =>
      _DialysisPartTwo_SubNursingInterviewState();
}

class _DialysisPartTwo_SubNursingInterviewState
    extends State<DialysisPartTwo_SubNursingInterview> {
  List<Map<String, dynamic>> questions = dialysisPartTwoQuestions;
