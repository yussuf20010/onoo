...
import 'Admin_PartOne_Questions.dart';
...
class AdminPartOneNursingInterview extends StatelessWidget {
  const AdminPartOneNursingInterview({super.key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        ...
        theme: theme,
        darkTheme: darkTheme,
        home: AdminPartOne_SubNursingInterview(),
      ),
    );
  }
}

class AdminPartOne_SubNursingInterview extends StatefulWidget {
  const AdminPartOne_SubNursingInterview({super.key});


  @override
  _AdminPartOne_SubNursingInterviewState createState() =>
      _AdminPartOne_SubNursingInterviewState();
}

class _AdminPartOne_SubNursingInterviewState
    extends State<AdminPartOne_SubNursingInterview> {
  List<Map<String, dynamic>> questions = AdminPartOneQuestions;
