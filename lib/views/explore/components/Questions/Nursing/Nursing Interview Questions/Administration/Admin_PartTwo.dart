...
import 'Admin_PartTwo_Questions.dart';
...
class AdminPartTwoNursingInterview extends StatelessWidget {
  const AdminPartTwoNursingInterview({Key? key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'Infection Control Part Two',
        theme: theme,
        darkTheme: darkTheme,
        home: AdminPartTwo_SubNursingInterview(),
      ),
    );
  }
}

class AdminPartTwo_SubNursingInterview extends StatefulWidget {
  const AdminPartTwo_SubNursingInterview({Key? key});

  @override
  _AdminPartTwo_SubNursingInterviewState createState() =>
      _AdminPartTwo_SubNursingInterviewState();
}

class _AdminPartTwo_SubNursingInterviewState
    extends State<AdminPartTwo_SubNursingInterview> {
  List<Map<String, dynamic>> questions = AdminPartTwoQuestions;
