...
import 'Admin_PartOne.dart';
import 'Admin_PartTwo.dart';

class AdminNursingQuestions extends StatelessWidget {
  const AdminNursingQuestions({super.key});
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: <Widget>[
                  _buildButton(context, 'Part 1', AdminPartOneNursingInterview()),
                  const SizedBox(height: 10), // Add spacing between the buttons
                  _buildButton(context, 'Part 2', AdminPartTwoNursingInterview()),
                  const SizedBox(height: 10), // Add spacing between the buttons
