...
import 'Psyco_PartOne_Questions.dart';
...
class PsycoPartOneNursingInterview extends StatelessWidget {
  const PsycoPartOneNursingInterview({super.key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        ...
        theme: theme,
        darkTheme: darkTheme,
        home: PsycoPartOne_SubNursingInterview(),
      ),
    );
  }
}

class PsycoPartOne_SubNursingInterview extends StatefulWidget {
  const PsycoPartOne_SubNursingInterview({super.key});

  @override
  _PsycoPartOne_SubNursingInterviewState createState() =>
      _PsycoPartOne_SubNursingInterviewState();
}

class _PsycoPartOne_SubNursingInterviewState
    extends State<PsycoPartOne_SubNursingInterview> {
  List<Map<String, dynamic>> questions = PsycoPartOneQuestions;
