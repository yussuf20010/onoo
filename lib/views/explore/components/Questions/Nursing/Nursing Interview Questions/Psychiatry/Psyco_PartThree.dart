...
import 'Psyco_PartThree_Questions.dart'; // Updated import for part three questions
...
class PsycoPartThreeNursingInterview extends StatelessWidget {
  const PsycoPartThreeNursingInterview({super.key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'Part Three', // Updated title
        theme: theme,
        darkTheme: darkTheme,
        home: PsycoPartThree_SubNursingInterview(), // Updated home
      ),
    );
  }
}

class PsycoPartThree_SubNursingInterview extends StatefulWidget {
  const PsycoPartThree_SubNursingInterview({super.key});


  @override
  _PsycoPartThree_SubNursingInterviewState createState() =>
      _PsycoPartThree_SubNursingInterviewState();
}

class _PsycoPartThree_SubNursingInterviewState
    extends State<PsycoPartThree_SubNursingInterview> {
  List<Map<String, dynamic>> questions =
      PsycoPartThreeQuestions; // Updated questions
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
            'Part (3) - Question ${currentQuestionIndex + 1}'), // Updated title
        leading: IconButton(
