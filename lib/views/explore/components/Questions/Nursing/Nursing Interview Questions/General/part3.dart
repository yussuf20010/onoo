...
import 'package:news_pro/views/explore/components/Questions/Nursing/Nursing%20Interview%20Questions/General/part3_questions.dart';
...
class PartThree_NursingInterview extends StatelessWidget {
  const PartThree_NursingInterview({Key? key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        ...
        theme: theme,
        darkTheme: darkTheme,
        home: PartThree_SubNursingInterview(),
      ),
    );
  }
}

class PartThree_SubNursingInterview extends StatefulWidget {
  const PartThree_SubNursingInterview({Key? key});

  @override
  _PartThree_SubNursingInterviewState createState() =>
      _PartThree_SubNursingInterviewState();
}

class _PartThree_SubNursingInterviewState
    extends State<PartThree_SubNursingInterview> {
  List<Map<String, dynamic>> questions = partThreeQuestions;
