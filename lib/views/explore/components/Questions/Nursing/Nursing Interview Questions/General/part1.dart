...
class PartOne_NursingInterview extends StatelessWidget {
  const PartOne_NursingInterview({Key? key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        ...
        theme: theme,
        darkTheme: darkTheme,
        home: PartOne_SubNursingInterview(),
      ),
    );
  }
}

class PartOne_SubNursingInterview extends StatefulWidget {
  const PartOne_SubNursingInterview({Key? key});

  @override
  _PartOne_SubNursingInterviewState createState() =>
      _PartOne_SubNursingInterviewState();
}

class _PartOne_SubNursingInterviewState
    extends State<PartOne_SubNursingInterview> {
  List<Map<String, dynamic>> questions = partOneQuestions;
