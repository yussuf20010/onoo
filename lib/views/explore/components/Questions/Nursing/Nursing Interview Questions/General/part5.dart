...
import 'package:news_pro/views/explore/components/Questions/Nursing/Nursing%20Interview%20Questions/General/part5_questions.dart';
...
class PartFive_NursingInterview extends StatelessWidget {
  const PartFive_NursingInterview({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'Interview Questions Part (5)',
        theme: theme,
        darkTheme: darkTheme,
        home: PartFive_SubNursingInterview(),
      ),
    );
  }
}

class PartFive_SubNursingInterview extends StatefulWidget {
  const PartFive_SubNursingInterview({Key? key}) : super(key: key);

  @override
  _PartFive_SubNursingInterviewState createState() =>
      _PartFive_SubNursingInterviewState();
}

class _PartFive_SubNursingInterviewState
    extends State<PartFive_SubNursingInterview> {
  List<Map<String, dynamic>> questions = partFiveQuestions;
