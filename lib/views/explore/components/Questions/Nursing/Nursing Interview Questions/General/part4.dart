...
import 'part4_questions.dart'; // Replace with the actual import for part4_questions.dart
...
class PartFour_NursingInterview extends StatelessWidget {
  const PartFour_NursingInterview({Key? key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'Interview Questions Part (4)',
        theme: theme,
        darkTheme: darkTheme,
        home: PartFour_SubNursingInterview(),
      ),
    );
  }
}

class PartFour_SubNursingInterview extends StatefulWidget {
  const PartFour_SubNursingInterview({Key? key});

  @override
  _PartFour_SubNursingInterviewState createState() =>
      _PartFour_SubNursingInterviewState();
}

class _PartFour_SubNursingInterviewState extends State<PartFour_SubNursingInterview> {
  List<Map<String, dynamic>> questions = partFourQuestions;
