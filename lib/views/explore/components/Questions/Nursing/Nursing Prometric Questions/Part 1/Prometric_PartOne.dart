...
import 'Prometric_PartOne_Questions.dart'; // Import your Part One questions file
...
class PrometricPartOneNursingQuestions extends StatelessWidget {
  const PrometricPartOneNursingQuestions({Key? key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'Prometric Questions Part One',
        theme: theme,
        darkTheme: darkTheme,
        home: PrometricPartOneSubNursingQuestions(),
      ),
    );
  }
}

class PrometricPartOneSubNursingQuestions extends StatefulWidget {
  const PrometricPartOneSubNursingQuestions({Key? key});

  @override
  _PrometricPartOneSubNursingQuestionsState createState() =>
      _PrometricPartOneSubNursingQuestionsState();
}

class _PrometricPartOneSubNursingQuestionsState
    extends State<PrometricPartOneSubNursingQuestions> {
  List<Map<String, dynamic>> questions = PrometricPartOneQuestions; // Use Part One questions
