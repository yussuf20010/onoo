...
import 'Prometric_PartFive_Questions.dart'; // Import your Part Five questions file
...
class PrometricPartFiveNursingQuestions extends StatelessWidget {
  const PrometricPartFiveNursingQuestions({Key? key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'Prometric Questions Part Five',
        theme: theme,
        darkTheme: darkTheme,
        home: PrometricPartFiveSubNursingQuestions(),
      ),
    );
  }
}

class PrometricPartFiveSubNursingQuestions extends StatefulWidget {
  const PrometricPartFiveSubNursingQuestions({Key? key});

  @override
  _PrometricPartFiveSubNursingQuestionsState createState() =>
      _PrometricPartFiveSubNursingQuestionsState();
}

class _PrometricPartFiveSubNursingQuestionsState
    extends State<PrometricPartFiveSubNursingQuestions> {
  List<Map<String, dynamic>> questions = PrometricPartFiveQuestions; // Use Part Five questions
