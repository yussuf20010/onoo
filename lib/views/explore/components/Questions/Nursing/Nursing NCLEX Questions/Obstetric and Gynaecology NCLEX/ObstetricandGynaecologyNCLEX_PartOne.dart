...
import 'ObstetricandGynaecologyNCLEX_PartOne_Questions.dart';
...
class ObstetricandGynaecologyNCLEXPartOne extends StatelessWidget {
  const ObstetricandGynaecologyNCLEXPartOne({super.key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'Obstetricand & Gynaecology NCLEX - Part One',
        theme: theme,
        darkTheme: darkTheme,
        home: ObstetricandGynaecologyNCLEXPartOne_Sub(),
      ),
    );
  }
}

class ObstetricandGynaecologyNCLEXPartOne_Sub extends StatefulWidget {
  const ObstetricandGynaecologyNCLEXPartOne_Sub({super.key});


  @override
  _ObstetricandGynaecologyNCLEXPartOne_SubState createState() =>
      _ObstetricandGynaecologyNCLEXPartOne_SubState();
}

class _ObstetricandGynaecologyNCLEXPartOne_SubState
    extends State<ObstetricandGynaecologyNCLEXPartOne_Sub> {
  List<Map<String, dynamic>> questions = ObstetricandGynaecologyNCLEXPartOneQuestions;
