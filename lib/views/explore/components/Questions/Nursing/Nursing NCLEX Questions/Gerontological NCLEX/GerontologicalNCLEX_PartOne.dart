...
import 'GerontologicalNCLEX_PartOne_Questions.dart';
...
class GerontologicalNCLEXPartOne extends StatelessWidget {
  const GerontologicalNCLEXPartOne({super.key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'Gerontological NCLEX - Part One',
        theme: theme,
        darkTheme: darkTheme,
        home: GerontologicalNCLEXPartOne_Sub(),
      ),
    );
  }
}

class GerontologicalNCLEXPartOne_Sub extends StatefulWidget {
  const GerontologicalNCLEXPartOne_Sub({super.key});


  @override
  _GerontologicalNCLEXPartOne_SubState createState() =>
      _GerontologicalNCLEXPartOne_SubState();
}

class _GerontologicalNCLEXPartOne_SubState
    extends State<GerontologicalNCLEXPartOne_Sub> {
  List<Map<String, dynamic>> questions = GerontologicalNCLEXPartOneQuestions;
