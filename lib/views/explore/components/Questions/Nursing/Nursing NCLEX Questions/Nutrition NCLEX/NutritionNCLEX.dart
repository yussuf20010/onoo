...
import 'NutritionNCLEX_PartOne.dart';
import 'NutritionNCLEX_PartTwo.dart';

class NutritionNCLEXQuestions extends StatelessWidget {
  const NutritionNCLEXQuestions({super.key});
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: <Widget>[
                  _buildButton(context, 'Part 1', NutritionNCLEXPartOne()),
                  const SizedBox(height: 10), // Add spacing between the buttons
                  _buildButton(context, 'Part 2', NutritionNCLEXPartTwo()),
                  const SizedBox(height: 10), // Add spacing between the buttons
                ],
              )
            ],
