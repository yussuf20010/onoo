...
import 'LeadershipManagementNCLEX_PartTwo_Questions.dart';
...
class LeadershipManagementNCLEXPartTwo extends StatelessWidget {
  const LeadershipManagementNCLEXPartTwo({super.key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'Leadership And Management NCLEX - Part Two',
        theme: theme,
        darkTheme: darkTheme,
        home: LeadershipManagementNCLEXPartTwo_Sub(),
      ),
    );
  }
}

class LeadershipManagementNCLEXPartTwo_Sub extends StatefulWidget {
  const LeadershipManagementNCLEXPartTwo_Sub({super.key});

  @override
  _LeadershipManagementNCLEXPartTwo_SubState createState() =>
      _LeadershipManagementNCLEXPartTwo_SubState();
}

class _LeadershipManagementNCLEXPartTwo_SubState
    extends State<LeadershipManagementNCLEXPartTwo_Sub> {
  List<Map<String, dynamic>> questions =
      LeadershipManagementNCLEXPartTwoQuestions;
