...
import 'LeadershipManagementNCLEX_PartOne_Questions.dart';
...
class LeadershipManagementNCLEXPartOne extends StatelessWidget {
  const LeadershipManagementNCLEXPartOne({super.key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'Leadership And Management NCLEX - Part One',
        theme: theme,
        darkTheme: darkTheme,
        home: LeadershipManagementNCLEXPartOne_Sub(),
      ),
    );
  }
}

class LeadershipManagementNCLEXPartOne_Sub extends StatefulWidget {
  const LeadershipManagementNCLEXPartOne_Sub({super.key});


  @override
  _LeadershipManagementNCLEXPartOne_SubState createState() =>
      _LeadershipManagementNCLEXPartOne_SubState();
}

class _LeadershipManagementNCLEXPartOne_SubState
    extends State<LeadershipManagementNCLEXPartOne_Sub> {
  List<Map<String, dynamic>> questions = LeadershipManagementNCLEXPartOneQuestions;
