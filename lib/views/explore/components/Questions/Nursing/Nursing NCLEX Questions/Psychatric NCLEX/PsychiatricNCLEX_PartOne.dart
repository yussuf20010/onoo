...
import 'PsychiatricNCLEX_PartOne_Questions.dart';
...
class PsychiatricNCLEXPartOne extends StatelessWidget {
  const PsychiatricNCLEXPartOne({super.key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'Psychiatric NCLEX - Part One',
        theme: theme,
        darkTheme: darkTheme,
        home: PsychiatricNCLEXPartOne_Sub(),
      ),
    );
  }
}

class PsychiatricNCLEXPartOne_Sub extends StatefulWidget {
  const PsychiatricNCLEXPartOne_Sub({super.key});


  @override
  _PsychiatricNCLEXPartOne_SubState createState() =>
      _PsychiatricNCLEXPartOne_SubState();
}

class _PsychiatricNCLEXPartOne_SubState
    extends State<PsychiatricNCLEXPartOne_Sub> {
  List<Map<String, dynamic>> questions = PsychiatricNCLEXPartOneQuestions;
