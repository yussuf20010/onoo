...
import 'MedicalSurgicalNCLEX_PartEight_Questions.dart';
...
class MedicalSurgicalNCLEXPartEight extends StatelessWidget {
  const MedicalSurgicalNCLEXPartEight({super.key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'Medical Surgical NCLEX - Part Eight',
        theme: theme,
        darkTheme: darkTheme,
        home: MedicalSurgicalNCLEXPartEight_Sub(),
      ),
    );
  }
}

class MedicalSurgicalNCLEXPartEight_Sub extends StatefulWidget {
  const MedicalSurgicalNCLEXPartEight_Sub({super.key});


  @override
  _MedicalSurgicalNCLEXPartEight_SubState createState() =>
      _MedicalSurgicalNCLEXPartEight_SubState();
}

class _MedicalSurgicalNCLEXPartEight_SubState
    extends State<MedicalSurgicalNCLEXPartEight_Sub> {
  List<Map<String, dynamic>> questions = MedicalSurgicalNCLEXPartEightQuestions;
