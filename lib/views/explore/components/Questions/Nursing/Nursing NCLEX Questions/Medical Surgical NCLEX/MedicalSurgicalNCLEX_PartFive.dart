...
import 'MedicalSurgicalNCLEX_PartFive_Questions.dart';
...
class MedicalSurgicalNCLEXPartFive extends StatelessWidget {
  const MedicalSurgicalNCLEXPartFive({super.key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'Medical Surgical NCLEX - Part Five',
        theme: theme,
        darkTheme: darkTheme,
        home: MedicalSurgicalNCLEXPartFive_Sub(),
      ),
    );
  }
}

class MedicalSurgicalNCLEXPartFive_Sub extends StatefulWidget {
  const MedicalSurgicalNCLEXPartFive_Sub({super.key});


  @override
  _MedicalSurgicalNCLEXPartFive_SubState createState() =>
      _MedicalSurgicalNCLEXPartFive_SubState();
}

class _MedicalSurgicalNCLEXPartFive_SubState
    extends State<MedicalSurgicalNCLEXPartFive_Sub> {
  List<Map<String, dynamic>> questions = MedicalSurgicalNCLEXPartFiveQuestions;
