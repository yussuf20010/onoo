...
import 'MedicalSurgicalNCLEX_PartSix_Questions.dart';
...
class MedicalSurgicalNCLEXPartSix extends StatelessWidget {
  const MedicalSurgicalNCLEXPartSix({super.key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'Medical Surgical NCLEX - Part Six',
        theme: theme,
        darkTheme: darkTheme,
        home: MedicalSurgicalNCLEXPartSix_Sub(),
      ),
    );
  }
}

class MedicalSurgicalNCLEXPartSix_Sub extends StatefulWidget {
  const MedicalSurgicalNCLEXPartSix_Sub({super.key});


  @override
  _MedicalSurgicalNCLEXPartSix_SubState createState() =>
      _MedicalSurgicalNCLEXPartSix_SubState();
}

class _MedicalSurgicalNCLEXPartSix_SubState
    extends State<MedicalSurgicalNCLEXPartSix_Sub> {
  List<Map<String, dynamic>> questions = MedicalSurgicalNCLEXPartSixQuestions;
