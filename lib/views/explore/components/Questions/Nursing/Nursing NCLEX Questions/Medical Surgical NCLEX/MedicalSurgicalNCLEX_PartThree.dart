...
import 'MedicalSurgicalNCLEX_PartThree_Questions.dart';
...
class MedicalSurgicalNCLEXPartThree extends StatelessWidget {
  const MedicalSurgicalNCLEXPartThree({super.key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'Medical Surgical NCLEX - Part Three',
        theme: theme,
        darkTheme: darkTheme,
        home: MedicalSurgicalNCLEXPartThree_Sub(),
      ),
    );
  }
}

class MedicalSurgicalNCLEXPartThree_Sub extends StatefulWidget {
  const MedicalSurgicalNCLEXPartThree_Sub({super.key});


  @override
  _MedicalSurgicalNCLEXPartThree_SubState createState() =>
      _MedicalSurgicalNCLEXPartThree_SubState();
}

class _MedicalSurgicalNCLEXPartThree_SubState
    extends State<MedicalSurgicalNCLEXPartThree_Sub> {
  List<Map<String, dynamic>> questions = MedicalSurgicalNCLEXPartThreeQuestions;
