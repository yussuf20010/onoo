...
import 'MedicalSurgicalNCLEX_PartSeven_Questions.dart';
...
class MedicalSurgicalNCLEXPartSeven extends StatelessWidget {
  const MedicalSurgicalNCLEXPartSeven({super.key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'Medical Surgical NCLEX - Part Seven',
        theme: theme,
        darkTheme: darkTheme,
        home: MedicalSurgicalNCLEXPartSeven_Sub(),
      ),
    );
  }
}

class MedicalSurgicalNCLEXPartSeven_Sub extends StatefulWidget {
  const MedicalSurgicalNCLEXPartSeven_Sub({super.key});


  @override
  _MedicalSurgicalNCLEXPartSeven_SubState createState() =>
      _MedicalSurgicalNCLEXPartSeven_SubState();
}

class _MedicalSurgicalNCLEXPartSeven_SubState
    extends State<MedicalSurgicalNCLEXPartSeven_Sub> {
  List<Map<String, dynamic>> questions = MedicalSurgicalNCLEXPartSevenQuestions;
