...
import 'MedicalSurgicalNCLEX_PartOne_Questions.dart';
...
class MedicalSurgicalNCLEXPartOne extends StatelessWidget {
  const MedicalSurgicalNCLEXPartOne({super.key});
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (theme, darkTheme) => MaterialApp(
        title: 'Medical Surgical NCLEX - Part One',
        theme: theme,
        darkTheme: darkTheme,
        home: MedicalSurgicalNCLEXPartOne_Sub(),
      ),
    );
  }
}

class MedicalSurgicalNCLEXPartOne_Sub extends StatefulWidget {
  const MedicalSurgicalNCLEXPartOne_Sub({super.key});


  @override
  _MedicalSurgicalNCLEXPartOne_SubState createState() =>
      _MedicalSurgicalNCLEXPartOne_SubState();
}

class _MedicalSurgicalNCLEXPartOne_SubState
    extends State<MedicalSurgicalNCLEXPartOne_Sub> {
  List<Map<String, dynamic>> questions = MedicalSurgicalNCLEXPartOneQuestions;
